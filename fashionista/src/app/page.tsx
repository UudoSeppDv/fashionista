...
import SectionTrends from '@/components/main-page/SectionTrends'
import SectionBanner from '@/components/main-page/SectionBanner'
import SectionRecentlyAdded from '@/components/main-page/SectionRecentlyAdded'
import SectionRecentlyViewd from '@/components/main-page/SectionRecentlyViewd'
...
export default function Home() {
  ...
  className="overflow-visible pointer-events-none absolute -z-10 left-[-150px] top-[1190px] 
             scale-[0.6] sm:scale-[0.75] md:scale-[0.9] lg:scale-100 origin-top-left"
>
      <path
